        ...
        <div className="container">
          <nav className="navbar navbar--footer">
            <a className="navbar-item" href="/">
              <div className="navbar__logo navbar__logo--footer">
                <img
                ...
                />
                <img
                  className="navbar__logo--add"
                  src="icons/addLogo.png"
                  alt="addLogo"
                />
              </div>
            </a>
            ...
            <div className="navbar__links navbar__links--footer">
              <a href="https://github.com/" className="navbar-item navbar-item--footer">
                github
              </a>
              <a href="https://github.com/" className="navbar-item navbar-item--footer">
                contacts
            ...
            <div className="navbar__totop ">
              <label className="navbar__totop-label" htmlFor="top">
                Back to top
              </label>
              ...
              >
                <svg
                  className="pageSection__button-arrow"

    ...
    <nav className="menu" id="menu" ref={menu}>
      ...
      <ul className="menu__list">
        <li className="menu__item">
          <NavLink to={{ pathname: '/', search }} className={getLinkClass} onClick={hideMenu}>
            Home
          </NavLink>
          <NavLink to={{ pathname: 'phones', search }} className={getLinkClass} onClick={hideMenu}>
            Phones
          </NavLink>
          <NavLink to={{ pathname: 'tablets', search }} className={getLinkClass} onClick={hideMenu}>
            Tablets
          </NavLink>
          <NavLink to={{ pathname: 'accessories', search }} className={getLinkClass} onClick={hideMenu}>
            Accesories
          </NavLink>
        </li>
      </ul>
      ...
      <div className="menu__footer">
        <NavLink to={{ pathname: 'favorites', search, hash: '' }} className={getClass} onClick={hideMenu}>
